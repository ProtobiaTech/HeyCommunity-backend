            ...
            <div id="section-mainbody">
                ...
                {!! Form::open(array('url' => '/dashboard/setting/update-wechat-pa', 'method' => 'post', 'class' => 'form form-horizontal', 'files' => true)) !!}
                    <div class="form-group {{ $errors->has('wx_app_id') ? 'has-error' : '' }}">
                        ...
                        <div class="col-sm-10">
                            <input type="string" name="wx_app_id" class="form-control" id="input-wx-app-id" placeholder="" value="{{ old('wx_app_id', $system->wx_app_id) }}">
                    ...
                    <div class="form-group {{ $errors->has('wx_app_secret') ? 'has-error' : '' }}">
                        ...
                        <div class="col-sm-10">
                            <input type="string" name="wx_app_secret" class="form-control" id="input-wx-app-secret" placeholder="" value="{{ old('wx_app_secret', $system->wx_app_secret) }}">
                    ...
                    <div class="form-group {{ $errors->has('enable_wechat_pa') ? 'has-error' : '' }}">
                        ...
                        <div class="col-sm-10">
                            <div class="radio radio-inline">
                              <label>
                                <input type="radio" name="enable_wechat_pa" value="1" {{ old('enable_wechat_pa', $system->enable_wechat_pa) ? 'checked' : '' }}> Yes
                              </label>
                            </div>
                            <div class="radio radio-inline">
                              <label>
                                <input type="radio" name="enable_wechat_pa" value="0" {{ old('enable_wechat_pa', $system->enable_wechat_pa) ? '' : 'checked' }}> No
                              </label>
                            </div>
                    ...
                    <div class="form-group {{ $errors->has('wx_temp_notice_id') ? 'has-error' : '' }}">
                        ...
                        <div class="col-sm-10">
                            <input type="string" name="wx_temp_notice_id" class="form-control" id="input-wx-app-id" placeholder="" value="{{ old('wx_temp_notice_id', $system->wx_temp_notice_id) }}">
